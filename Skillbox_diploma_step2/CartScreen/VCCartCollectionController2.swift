//
//  VCCartCollectionController2.swift
...
class VCCartCollectionController2: UICollectionViewController {
        ...
        //MARK: - делегаты и переменные
            ...
            func makeDataSource() -> DataSourceAlias {
                print("0000")
                let dataSource = DataSourceAlias(collectionView: collectionView, cellProvider: { (collectionView, indexPath, cartGoodsDiffable) -> UICollectionViewCell? in
